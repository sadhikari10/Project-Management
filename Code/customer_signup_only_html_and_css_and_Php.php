...
<form action="process.php" method="post" enctype="multipart/form-data">
    <fieldset>
        ...
        <div class="form-group">
            <div class="nested-div">
                <label><i class="fas fa-user icon"></i>Firstname</label>
                <input type="text" name="firstname" placeholder="Enter your first name" required>
            </div>
            <!-- <div class="nested-div">
                <label><i class="fas fa-user icon"></i>Middlename</label>
                <input type="text" name="middlename" placeholder="Enter your middle name" required>
            </div> -->
            <div class="nested-div">
                <label><i class="fas fa-user icon"></i>Lastname</label>
        ...
        <div class="box-container">
            ...
            <div class="form-group">
                <label><i class="fas fa-lock icon"></i>Re-enter Password</label>
            ...
            <div class="form-group">
                <label><i class="fas fa-phone icon"></i>Contact Number</label>
                <input type="tel" name="contact_number" placeholder="Enter your contact number" required>
            </div>
            <div class="form-group">
                <label><i class="fas fa-image icon"></i>Profile Picture</label>
    ...
    <div class="form-group">
                <label><i class="fas fa-image icon"></i>Already have an account?</label>
