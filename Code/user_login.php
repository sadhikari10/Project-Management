        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="nested-div">
                    <label><i class="fa fa-user icon"></i>Email or Phone</label>
                    <input type="text" name="firstname" placeholder="Enter your Email-address or Phone  " required>
                </div>
            </div>
...
<div class="ram">
    <label style="font-style: italic;"> <a href=" "> New Here? Sign Up Now</a></label>
</div>
