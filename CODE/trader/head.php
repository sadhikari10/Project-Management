...
.register-as {
    ...
    margin-top: 20px; /* Add space between the heading and radio buttons */
}


.checkbox-container {
    display: flex;
    flex-direction: column; /* Display the radio buttons vertically */
    align-items: flex-start; /* Align the radio buttons to the left */
}

.checkbox-container label {
    margin-bottom: 10px; /* Add some spacing between each radio button */
}
