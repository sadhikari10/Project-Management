...
<html lang="en">
    ...
    <body style="background: radial-gradient(#fff,#F5F5DC)">
        <div class="video-background">
            <div class="container"> 
                <form action="trader_code.php" method="post" enctype="multipart/form-data">
                ...
                <div class="kipp">
                    ...
                    <button class="btn btn-primary" onclick="window.location.href='trader_login.php'"> Sign In </button></label>
                </div>
            </div> 
        ...
        <div id="termsModal" class="modal">
            <div class="modal-content">
                ...
                <p>By clicking on Terms and Conditions you agree to share your personal information
                    with ShopSphere website. Your data will be held and be modified by you and admin panel only.</p>
            </div>
        </div>
            </div>
        </div>
